...
// Using a type alias with intersection instead of interface extending indexed access type
type CustomIpcRenderer = BaseElectronAPI["ipcRenderer"] & {
  ...
  interface Window {
    ...
    api: {
      onActiveWindowChanged: (
        callback: (details: ActiveWindowDetails) => void,
