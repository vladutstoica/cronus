...
function App() {
  ...
  function setupCsp() {
    ...
    const csp = `default-src 'self'; script-src 'self' https://*.loom.com https://*.prod-east.frontend.public.atl-paas.net ${is.dev ? "'unsafe-eval' 'unsafe-inline' " + devServerURL : ""}; style-src 'self' 'unsafe-inline' https://fonts.gstatic.com https://*.loom.com https://*.prod-east.frontend.public.atl-paas.net; font-src 'self' https://fonts.gstatic.com https://*.loom.com https://*.prod-east.frontend.public.atl-paas.net; media-src 'self' data: blob: https://cdn.loom.com https://*.loom.com; img-src * data:; frame-src https://*.loom.com; connect-src 'self' https://cdn.jsdelivr.net http://localhost:3001 http://127.0.0.1:3001 https://*.loom.com https://api-private.atlassian.com https://as.atlassian.com https://*.prod-east.frontend.public.atl-paas.net https://cronusnewupdates.s3.amazonaws.com ${is.dev ? devServerURL : ""}; worker-src 'self' blob:`;
