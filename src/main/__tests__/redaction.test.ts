...
describe("redactSensitiveContent", () => {
  describe("credit card redaction", () => {
    it("should redact Visa card numbers", () => {
      expect(redactSensitiveContent("Card: 4111-1111-1111-1111")).toContain(
        "[REDACTED_CC]",
      );
      expect(redactSensitiveContent("Card: 4111 1111 1111 1111")).toContain(
        "[REDACTED_CC]",
      );
      expect(redactSensitiveContent("Card: 4111111111111111")).toContain(
        "[REDACTED_CC]",
      );
    });

    it("should redact Mastercard numbers", () => {
      expect(redactSensitiveContent("Card: 5500-0000-0000-0004")).toContain(
        "[REDACTED_CC]",
      );
      expect(redactSensitiveContent("Card: 2221-0012-3456-7890")).toContain(
        "[REDACTED_CC]",
      );
    });
    ...
    it("should redact Amex card numbers", () => {
      ...
      expect(redactSensitiveContent("Card: 340000000000009")).toContain(
        "[REDACTED_CC]",
      );
      // Amex with 4-4-4-3 grouping
      expect(redactSensitiveContent("Card: 3782-8224-6310-005")).toContain(
        "[REDACTED_CC]",
      );
    });

    it("should redact Discover card numbers", () => {
      expect(redactSensitiveContent("Card: 6011-0000-0000-0004")).toContain(
        "[REDACTED_CC]",
      );
      expect(redactSensitiveContent("Card: 6500-0000-0000-0002")).toContain(
        "[REDACTED_CC]",
      );
    });
  ...
  describe("SSN redaction", () => {
    it("should redact SSN patterns", () => {
      expect(redactSensitiveContent("SSN: 123-45-6789")).toContain(
        "[REDACTED_SSN]",
      );
    });
    ...
    it("should redact SSN in middle of text", () => {
      const result = redactSensitiveContent(
        "My SSN is 456-78-9012 and more text",
      );
  ...
  describe("password redaction", () => {
    it("should redact password patterns", () => {
      expect(redactSensitiveContent("password: mySecret123")).toContain(
        "[REDACTED]",
      );
  ...
  describe("API key redaction", () => {
    it("should redact Stripe-style keys", () => {
      expect(redactSensitiveContent("sk_live_abc123xyz")).toContain(
        "[REDACTED]",
      );
      expect(redactSensitiveContent("pk_test_abc123xyz")).toContain(
        "[REDACTED]",
      );
    });

    it("should redact API key patterns", () => {
      expect(redactSensitiveContent("API key: my-secret-key-123")).toContain(
        "[REDACTED]",
      );
    });
  });
  ...
  describe("Bearer/Basic token redaction", () => {
    it("should redact Bearer tokens", () => {
      expect(redactSensitiveContent("Bearer abc123token")).toContain(
        "[REDACTED]",
      );
    });

    it("should redact Basic auth", () => {
      expect(redactSensitiveContent("Basic dXNlcjpwYXNz")).toContain(
        "[REDACTED]",
      );
    });
  });
  ...
  describe("phone number redaction", () => {
    it("should redact US phone numbers", () => {
      expect(redactSensitiveContent("Call (555) 123-4567")).toContain(
        "[REDACTED_PHONE]",
      );
      expect(redactSensitiveContent("Phone: 555-123-4567")).toContain(
        "[REDACTED_PHONE]",
      );
      expect(redactSensitiveContent("Tel: +1-555-123-4567")).toContain(
        "[REDACTED_PHONE]",
      );
    });
  });
