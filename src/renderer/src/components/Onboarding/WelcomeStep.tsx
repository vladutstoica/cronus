...
export function WelcomeStep() {
  return (
    <div className="text-center space-y-6">
      <img src={gdprlogoblue} alt="GDPR Logo" className="h-32 mx-auto dark:hidden" />
      <img src={gdprlogowhite} alt="GDPR Logo" className="h-32 mx-auto hidden dark:block" />
      <p className="text-md text-muted-foreground max-w-md mx-auto leading-relaxed">
        To categorize your activity, we periodically take screenshots of your active window and use
