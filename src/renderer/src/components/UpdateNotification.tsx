    ...
    <AlertDialog open={isRestarting}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Restarting to apply the update. This can take up to 30 seconds!
            After the app closes it can take up to 1 minute for the update to be
            applied. Please do not open it until it opens back up by itself.
          </AlertDialogDescription>
        </AlertDialogHeader>
